...
**How-to guides (plain-English, with screenshots):**

- [docs/guides/parent-guide.md](docs/guides/parent-guide.md) — for parents:
  registering, paying, retrieving the update link, and editing a registration.
- [docs/guides/admin-guide.md](docs/guides/admin-guide.md) — for staff: the
  family lists, allergies/medical, class placement, payment override, and CSV
  import/export.

The guide screenshots live in `docs/guides/images/` and are generated by a Dusk
capture (not a regression test), guarded so it never runs in CI. To refresh them
after a UI change:
